...
function Automaton_sTrade:CreateFrame()
	...
	--列标题统一金色
	for _, ttl in ipairs({
		self.sTradeLLFrame.titlesa, self.sTradeLLFrame.titlesb, self.sTradeLLFrame.titlesc,
		self.sTradeLLFrame.titlesd, self.sTradeLLFrame.titlese, self.sTradeLLFrame.titlesf,
	...
	--顶部按钮b-清除（蓝色扁平按钮）
	self.sTradeLLFrame.buttonb, self.sTradeLLFrame.buttonbtext = Automaton.CreateFlatButton(self.sTradeLLFrame.main, 60, 20, "清除")
...
function Automaton_sTrade:sTradeLLUpdate()
	...
	if not STradeDB then return end
