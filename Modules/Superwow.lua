...
local function AutoOpenRebuildCustom()
    ...
    for idStr in pairs(tbl) do
        ...
        if idNum then AutoOpenCustomSet[idNum] = true end
    end
end
...
local function AutoOpenCanOpen(bag, slot)
    if not ITEM_OPENABLE then return true end          -- 客户端未定义该全局时信任白名单
    ...
    if not ok then return true end                       -- 读不出就信任白名单
    local n = AutoOpenScanTip:NumLines() or 0
    if n == 0 then return true end                       -- tooltip 为空，信任白名单
    for i = 1, n do
...
local function AutoOpenForbidden()
    if (LootFrame and LootFrame:IsVisible()) or
       ...
       (AuctionFrame and AuctionFrame:IsVisible()) then
        return true
    end
    return false
end
...
function Automaton_Superwow:AutoOpenContainers()
    if not self.db.profile.autoopen then return end
    if AutoOpenBusy or AutoOpenPending then return end   -- 已在处理或已排程，跳过
    AutoOpenPending = true
    local function run()
        AutoOpenPending = false
        if not self.db.profile.autoopen then return end
        if AutoOpenForbidden() then return end            -- 拾取/交易/银行等界面打开时不自动开
        AutoOpenBusy = true
        for bag = 0, 4 do
...
local function PfuiControlsNameplates()
    if not _G.pfUI then return false end
...
Automaton_Superwow.options = {
    ...
    autoloot = {
        ...
        get = function() return Automaton_Superwow.db.profile.autoloot end,
        set = function(v)
            if v then Automaton_Superwow.db.profile.shiftloot = false end
    ...
    shiftloot = {
        ...
        set = function(v)
            if v then Automaton_Superwow.db.profile.autoloot = false end
    ...
    clickthrough = {
        ...
        set = function(v)
            if v then Clickthrough(1) else Clickthrough(0) end
    ...
    autoopen = {
        ...
        order = 14,
        get = function() return Automaton_Superwow.db.profile.autoopen end,
        set = function(v)
        ...
        args = {
            ...
            list = {
                ...
                func = function()
                    ...
                    if n == 0 then Automaton:Print("(空)") end
                end,
            },
            purge = {
                type = "execute",
    ...
    fov = {
        ...
        get = function() return Automaton_Superwow.db.profile.fov end,
        set = function(v)
    ...
    backgroundsound = {
        ...
        order = 22,
        get = function() return Automaton_Superwow.db.profile.backgroundsound end,
        set = function(v)
    ...
    uncappedsounds = {
        ...
        get = function() return SafeGetCVar("UncapSounds", "0") == "1" end,
        set = function(v)
            if v then
    ...
    LootSparkle = {
        ...
        get = function() return Automaton_Superwow.db.profile.LootSparkle end,
        set = function(v)
    ...
    SelectionCircleStyle = {
        ...
        min = 1, max = 4, step = 1,
        get = function() return Automaton_Superwow.db.profile.SelectionCircleStyle end,
        set = function(v)
    ...
    healingtext = {
        ...
        get = function() return SafeGetCVar("HealingText", Automaton_Superwow.db.profile.healingtext) == "1" end,
        set = function(v)
    ...
    nameplates = {
        ...
        args = {
            nameplaterange = {
                ...
                get = function() return tonumber(SafeGetCVar("NameplateRange", Automaton_Superwow.db.profile.nameplaterange)) or 40 end,
                set = function(v)
            ...
            nameplatemotion = {
                ...
                order = 2,
                desc = L["Changes how nameplates move when they overlap."] .. " " .. L["0=Overlap, 1=Default, 2=Smart, 3=Compact"] .. " " .. L["Nameplate Motion is disabled while pfUI nameplates are active (pfUI owns stacking)."],
                min = 0, max = 3, step = 1,
                get = function() return Automaton_Superwow.db.profile.nameplatemotion or 0 end,
                set = function(v)
    ...
    chatbubbles = {
        ...
        args = {
            chatbubblerange = {
                ...
                get = function() return tonumber(SafeGetCVar("ChatBubbleRange", Automaton_Superwow.db.profile.chatbubblerange)) or 80 end,
                set = function(v)
            ...
            togglesay = {
                ...
                get = function() return SafeGetCVar("ChatBubbles", Automaton_Superwow.db.profile.togglesay) == "1" end,
                set = function(v)
            ...
            togglepartybubbles = {
                ...
                get = function() return SafeGetCVar("ChatBubblesParty", Automaton_Superwow.db.profile.togglepartybubbles) == "1" end,
                set = function(v)
            ...
            toggleraidbubbles = {
                ...
                get = function() return SafeGetCVar("ChatBubblesRaid", Automaton_Superwow.db.profile.toggleraidbubbles) == "1" end,
                set = function(v)
            ...
            togglebgbubbles = {
                ...
                get = function() return SafeGetCVar("ChatBubblesBattleground", Automaton_Superwow.db.profile.togglebgbubbles) == "1" end,
                set = function(v)
            ...
            togglewhisperbubbles = {
                ...
                get = function() return SafeGetCVar("ChatBubblesWhisper", Automaton_Superwow.db.profile.togglewhisperbubbles) == "1" end,
                set = function(v)
            ...
            togglecreaturebubbles = {
                ...
                get = function() return SafeGetCVar("ChatBubblesCreatures", Automaton_Superwow.db.profile.togglecreaturebubbles) == "1" end,
                set = function(v)
...
function Automaton_Superwow:OnEnable()
    ...
    if CombatText_AddMessage then self:Hook("CombatText_AddMessage") end
...
function Automaton_Superwow:TurnOnAutoloot()
    ...
    if self.db.profile.shiftloot then
        ...
        self.f:SetScript("OnUpdate", function()
            if IsShiftKeyDown() then SetAutoloot(1) else SetAutoloot(0) end
        end)
...
function Automaton_Superwow:WatchPfUINameplateOwnership()
    if PfuiControlsNameplates() then return end  -- 已经由 PFUI 接管，无需监听
    local mod = self
